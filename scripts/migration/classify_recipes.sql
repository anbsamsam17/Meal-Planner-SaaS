-- Classification des recettes : course + cuisine_type
-- Genere par scripts/classify_recipes.py
-- 338 recettes classifiees
--
-- Valeurs course : plat_principal, accompagnement, dessert,
--   boisson, entree, petit_dejeuner, pain_viennoiserie, sauce_condiment
--
-- A executer APRES la migration 0009 (ajout colonne course)
-- et sur Supabase manuellement.
...
UPDATE recipes SET course = 'sauce_condiment', cuisine_type = 'française' WHERE id = '3522e7d8-c8fa-4dd8-ae46-cb94368267cc';

-- Aubergines au four
UPDATE recipes SET course = 'plat_principal', cuisine_type = 'française' WHERE id = '52f9e0af-f14d-4e32-ab8a-5c7e02be581f';
...
UPDATE recipes SET course = 'plat_principal', cuisine_type = 'française' WHERE id = '63369447-d240-41d4-b08d-e26f038b5b58';

-- Bavarois framboise
UPDATE recipes SET course = 'plat_principal', cuisine_type = 'française' WHERE id = '385aec86-2da1-40a4-86fd-739dd171a599';

-- Bavarois framboise et pistache
UPDATE recipes SET course = 'plat_principal', cuisine_type = 'française' WHERE id = '663a8cf2-50ea-46ff-9e63-46780a5ce971';

-- Beignets de carnaval ultra moelleux de ma grand-mère
UPDATE recipes SET course = 'plat_principal', cuisine_type = 'française' WHERE id = '41a6ae84-dd34-441f-808e-0459db5492f9';

-- Beignets de courgettes râpées faciles
UPDATE recipes SET course = 'plat_principal', cuisine_type = 'française' WHERE id = 'b3ae0807-0009-434a-9409-91b965a98a77';

-- Beignets de fleur de courgette par Laurent Mariotte
UPDATE recipes SET course = 'plat_principal', cuisine_type = 'française' WHERE id = '6d5f8d73-3b3f-4c6f-82f6-52c396073051';

-- Biscuits banane - coco
UPDATE recipes SET course = 'plat_principal', cuisine_type = 'française' WHERE id = 'fbda0384-8a4f-4064-a96d-6d98178de78a';

-- Biscuits sablés au beurre
UPDATE recipes SET course = 'plat_principal', cuisine_type = 'française' WHERE id = '25627761-7f2a-4155-9bc0-d1bbb962da2d';
...
-- Bobun au bœuf
UPDATE recipes SET course = 'plat_principal', cuisine_type = 'française' WHERE id = '6238fb7a-faa7-45f9-a664-0289b512ab7d';
...
UPDATE recipes SET course = 'plat_principal', cuisine_type = 'française' WHERE id = '5f4398f1-2fc1-4401-91d7-ac6223631fe8';
...
-- Boule auvergnate
UPDATE recipes SET course = 'plat_principal', cuisine_type = 'française' WHERE id = '7d18f729-a2e9-4757-85d2-2d749c070e44';

-- Bowl cake aux flocons d''avoine
UPDATE recipes SET course = 'plat_principal', cuisine_type = 'française' WHERE id = '1d8feddb-da93-47e0-9831-78b13782246c';
...
UPDATE recipes SET course = 'pain_viennoiserie', cuisine_type = 'française' WHERE id = '0b988bc4-740a-4e43-9585-7952edacdb06';
...
-- Bugnes
UPDATE recipes SET course = 'plat_principal', cuisine_type = 'française' WHERE id = 'e0a2f69c-399a-4ccd-9d73-db1e540d9031';
...
UPDATE recipes SET course = 'sauce_condiment', cuisine_type = 'française' WHERE id = '7196e89c-faf6-457e-9a3a-c3746640d3d6';

-- Bûche salée au saumon et aux épinards
UPDATE recipes SET course = 'dessert', cuisine_type = 'française' WHERE id = 'fdbb6349-7d99-4ad0-9e0e-988e3f60243e';
...
UPDATE recipes SET course = 'plat_principal', cuisine_type = 'française' WHERE id = 'e5d9b047-02d7-433a-b423-04d278439b5d';

-- Cake salé au jambon et aux olives
UPDATE recipes SET course = 'plat_principal', cuisine_type = 'française' WHERE id = '8ebc6dbd-1eaa-4827-8e11-947357df83b9';

-- Cake salé rapide et facile
UPDATE recipes SET course = 'plat_principal', cuisine_type = 'française' WHERE id = 'b089b455-820c-4580-b37c-9b0a3b71628e';

-- Cake à la banane / banana bread (USA)
UPDATE recipes SET course = 'dessert', cuisine_type = 'américaine' WHERE id = '009331eb-8013-447b-84a3-48748a772d06';

-- Camembert Coeur de lion rôti au four
UPDATE recipes SET course = 'plat_principal', cuisine_type = 'française' WHERE id = '780fa792-0f5f-4228-a0a0-79bc4a1809cc';

-- Camembert rôti au barbecue
UPDATE recipes SET course = 'plat_principal', cuisine_type = 'française' WHERE id = 'cdde2f1a-f6d4-4478-b767-426aaf8525c6';

-- Cannelloni au boeuf
UPDATE recipes SET course = 'plat_principal', cuisine_type = 'française' WHERE id = '41ad246c-8c9b-4afa-ac3c-cb4e23c519fa';

-- Cannellonis ricotta et épinards à la sauce tomate
UPDATE recipes SET course = 'accompagnement', cuisine_type = 'française' WHERE id = 'fbe2dac6-9175-4eaf-89e2-bebe28506817';

-- Carbonades flamandes traditionnelles
UPDATE recipes SET course = 'plat_principal', cuisine_type = 'française' WHERE id = '51232d37-4fcb-4527-a08c-34cd35238289';
...
UPDATE recipes SET course = 'plat_principal', cuisine_type = 'française' WHERE id = '6b7fcdee-faea-4b6c-8ee3-142ad41ae6f5';
...
UPDATE recipes SET course = 'boisson', cuisine_type = 'française' WHERE id = 'e7340746-11a3-4b6d-a7dc-ede9962df238';
...
UPDATE recipes SET course = 'plat_principal', cuisine_type = 'française' WHERE id = 'd8feb989-7439-4e65-80f5-f603a6762cf5';

-- Chou rouge aux pommes (de ma grand-mère)
UPDATE recipes SET course = 'plat_principal', cuisine_type = 'française' WHERE id = 'cee59dd9-db60-4f26-8e4c-b225833e1f86';

-- Chou-fleur au Air Fryer
UPDATE recipes SET course = 'plat_principal', cuisine_type = 'française' WHERE id = '8eaccac2-5e84-4ea7-bd36-d4f3426c3020';

-- Chou-fleur au Cookeo
UPDATE recipes SET course = 'plat_principal', cuisine_type = 'française' WHERE id = '7c0a0311-c1d2-4479-8a4e-5b93d0e797cd';

-- Choux (vert) braisé
UPDATE recipes SET course = 'plat_principal', cuisine_type = 'française' WHERE id = 'b700ae90-2246-4f89-a8e2-e2016d0e55e2';

-- Choux de Bruxelles au lard en cocotte
UPDATE recipes SET course = 'plat_principal', cuisine_type = 'française' WHERE id = '9a115cc0-8cd7-4858-a5b9-74ccfa6c9461';

-- Choux-Choux soja sésame !
UPDATE recipes SET course = 'plat_principal', cuisine_type = 'française' WHERE id = '533d5bf1-847c-4c50-a6f4-0ecf755a7bcc';
...
UPDATE recipes SET course = 'plat_principal', cuisine_type = 'française' WHERE id = '68082712-95f8-423f-9c3c-5321e0c2fac4';

-- Conchiglioni farcis à la ricotta, jambon et tomates séchées
UPDATE recipes SET course = 'plat_principal', cuisine_type = 'française' WHERE id = '47c1eadb-3b2a-4e65-9d79-9d963439d6be';
...
UPDATE recipes SET course = 'plat_principal', cuisine_type = 'italienne' WHERE id = '1dcaee1a-d104-4fd0-802a-7b8c9fffb673';

-- Courgettes au Air Fryer
UPDATE recipes SET course = 'plat_principal', cuisine_type = 'française' WHERE id = '2bb89581-4c2a-488c-844c-2ba73ce166e8';
...
UPDATE recipes SET course = 'plat_principal', cuisine_type = 'indienne' WHERE id = '19d43ad5-a5e2-4cab-a666-1205305c98a6';

-- Croque croissant au jambon et au comté
UPDATE recipes SET course = 'pain_viennoiserie', cuisine_type = 'française' WHERE id = '78e768b0-2b82-41a8-879d-bf068a7dea45';
...
UPDATE recipes SET course = 'plat_principal', cuisine_type = 'française' WHERE id = '2b9d5d1d-8736-48c8-a773-479da4876328';
...
-- Crème pâtissière
UPDATE recipes SET course = 'plat_principal', cuisine_type = 'française' WHERE id = '99c6daab-ce6b-458f-ba04-222e31ede681';
...
UPDATE recipes SET course = 'plat_principal', cuisine_type = 'française' WHERE id = '22c1d5de-04a4-4aa1-a2f3-09c0e8cd8bed';

-- Dakgangjeong, le poulet frit coréen
UPDATE recipes SET course = 'plat_principal', cuisine_type = 'française' WHERE id = '6699f398-785d-44a1-bf9c-003e8140b913';

-- Ebly au curry et au coco
UPDATE recipes SET course = 'plat_principal', cuisine_type = 'indienne' WHERE id = '55513504-7275-482a-9ff2-f28be4f03c0a';
...
UPDATE recipes SET course = 'plat_principal', cuisine_type = 'française' WHERE id = 'f181d71b-1586-45b4-bd61-45d375eba116';
...
UPDATE recipes SET course = 'plat_principal', cuisine_type = 'française' WHERE id = '7b2bc50b-82e3-4a8a-8cde-612df131f45b';

-- Financiers aux framboises et citron vert
UPDATE recipes SET course = 'plat_principal', cuisine_type = 'française' WHERE id = 'e7890f7f-5c65-4743-bba4-504d562f269d';
...
UPDATE recipes SET course = 'dessert', cuisine_type = 'française' WHERE id = 'e1066926-6f36-4e97-bbaa-146e7541c57f';

-- Flan de courgettes
UPDATE recipes SET course = 'dessert', cuisine_type = 'française' WHERE id = 'e8f63145-9784-46ff-964c-e13712a0c1de';
...
UPDATE recipes SET course = 'plat_principal', cuisine_type = 'française' WHERE id = 'e82bd4a6-0595-4c2e-8432-ce2f6aa8bc22';

-- Fondue Savoyarde
UPDATE recipes SET course = 'plat_principal', cuisine_type = 'française' WHERE id = 'e9a60690-f10b-4bc5-84ed-b659774386b3';

-- Fondue aux poireaux
UPDATE recipes SET course = 'plat_principal', cuisine_type = 'française' WHERE id = 'a85586bc-f347-4e06-82f1-87e74991cfeb';

-- Fondue de poireaux
UPDATE recipes SET course = 'plat_principal', cuisine_type = 'française' WHERE id = '336ca473-350e-465e-b53b-9b9c57c6b208';

-- Frites de patate douce sans friture !
UPDATE recipes SET course = 'accompagnement', cuisine_type = 'française' WHERE id = '91ffd0c9-21c4-4bfe-839f-15deb426b46c';

-- Galette de pomme de terre & carotte
UPDATE recipes SET course = 'plat_principal', cuisine_type = 'française' WHERE id = 'e57f2c52-1698-4532-8c25-c12ce668dad9';

-- Galette des rois à la frangipane
UPDATE recipes SET course = 'plat_principal', cuisine_type = 'française' WHERE id = '27995f0d-e86e-4111-81b0-7fb44bd6770b';

-- Galettes de chou-fleur (rösti)
UPDATE recipes SET course = 'plat_principal', cuisine_type = 'française' WHERE id = '6d7e06c9-c14c-483f-b894-413f0de405fa';
...
UPDATE recipes SET course = 'petit_dejeuner', cuisine_type = 'française' WHERE id = 'b3d058cc-0694-49e0-9931-7b574943d800';
...
UPDATE recipes SET course = 'petit_dejeuner', cuisine_type = 'française' WHERE id = '70bd07cb-a99e-432f-ae1a-747762da8269';
...
-- Gingembre confit
UPDATE recipes SET course = 'plat_principal', cuisine_type = 'française' WHERE id = '05383556-53bf-4374-8db2-96c0fe77feae';
...
UPDATE recipes SET course = 'plat_principal', cuisine_type = 'française' WHERE id = 'd952fe1b-9dc2-42fb-ae64-c4f9e086efcb';
...
UPDATE recipes SET course = 'plat_principal', cuisine_type = 'française' WHERE id = '1274ab8c-14f9-4832-9fe4-906a0db8a1f5';
...
-- Gratin de poireaux
UPDATE recipes SET course = 'plat_principal', cuisine_type = 'française' WHERE id = '66bf379b-a8ea-4200-92ef-75fc05aef17d';
...
UPDATE recipes SET course = 'dessert', cuisine_type = 'française' WHERE id = '8b09606e-6cd0-4899-a87c-f5c9fd7e70e1';

-- Gratin de potimarron
UPDATE recipes SET course = 'plat_principal', cuisine_type = 'française' WHERE id = '5ab0156f-d488-4b10-823b-c05f4a1f82c0';
...
UPDATE recipes SET course = 'dessert', cuisine_type = 'française' WHERE id = 'dcc93742-5954-49d1-acea-677dca57c621';
...
-- La faluche
UPDATE recipes SET course = 'plat_principal', cuisine_type = 'française' WHERE id = 'b7395586-806a-47af-b87f-57710b604b42';
...
UPDATE recipes SET course = 'plat_principal', cuisine_type = 'française' WHERE id = '46b97f2c-e872-4832-82f5-67f8d382cf24';
...
-- Le vrai houmous
UPDATE recipes SET course = 'entree', cuisine_type = 'libanaise' WHERE id = '93499c7d-6588-483c-b712-52d75b108c4f';

-- Lentilles Vertes du Puy
UPDATE recipes SET course = 'plat_principal', cuisine_type = 'française' WHERE id = '16af8358-886c-4728-a41b-69a0db18d3be';

-- Les meringues maison
UPDATE recipes SET course = 'plat_principal', cuisine_type = 'française' WHERE id = '71eefce8-c74c-4a10-922f-8f0f41ee16ec';

-- Les nems de ma grand mère (recette originale)
UPDATE recipes SET course = 'plat_principal', cuisine_type = 'française' WHERE id = 'd10675f4-ca93-4fd8-8ede-b2c548a982f0';
...
UPDATE recipes SET course = 'boisson', cuisine_type = 'française' WHERE id = 'af6eb9c8-9d8f-40b3-92d5-6db692ffbafe';
...
UPDATE recipes SET course = 'dessert', cuisine_type = 'française' WHERE id = 'c7c802e0-7223-41cb-af2c-b7b732661977';
...
-- Mochi au spéculoos
UPDATE recipes SET course = 'plat_principal', cuisine_type = 'française' WHERE id = '38dbacd9-bd56-4cb0-93fa-a58f08680f30';

-- Mont d''or au four classique
UPDATE recipes SET course = 'boisson', cuisine_type = 'française' WHERE id = '40130ca5-cc7b-402c-947a-aac91566321a';

-- Morue au four à la portugaise
UPDATE recipes SET course = 'plat_principal', cuisine_type = 'française' WHERE id = '13475540-574e-43fc-b1e6-0dbad6604cfe';
...
-- Muffins au chocolat
UPDATE recipes SET course = 'plat_principal', cuisine_type = 'française' WHERE id = '4f433ea8-851e-4ea0-b06a-58cdcaa3ef8a';

-- Muffins chocolat noir Bio Nestlé Dessert®, huile d''olive & framboise
UPDATE recipes SET course = 'plat_principal', cuisine_type = 'française' WHERE id = '0abfdad2-8c26-4fec-95e4-4fb7968f3e2e';

-- Mug Cake rapide au chocolat
UPDATE recipes SET course = 'plat_principal', cuisine_type = 'française' WHERE id = '41838439-d478-4372-9e14-ddfb0b1cd707';
...
-- Navarin d''agneau
UPDATE recipes SET course = 'plat_principal', cuisine_type = 'marocaine' WHERE id = '89cabf4f-8f75-41b4-95d7-2f90eedfcfc5';
...
UPDATE recipes SET course = 'plat_principal', cuisine_type = 'française' WHERE id = '4237f01b-8ec8-4a48-b7bb-602329783c30';

-- Oeufs cocottes
UPDATE recipes SET course = 'plat_principal', cuisine_type = 'française' WHERE id = 'a807430c-16b8-4c6c-852e-df9021368de1';

-- Oeufs en Meurette de ma Maman
UPDATE recipes SET course = 'plat_principal', cuisine_type = 'française' WHERE id = 'e2ac07dd-a874-4609-a03c-5c9276d24479';

-- Oeufs mimosa
UPDATE recipes SET course = 'plat_principal', cuisine_type = 'française' WHERE id = '6556547f-672d-4353-8abe-4acefea0a664';

-- Oeufs mollets de ma grand-mère
UPDATE recipes SET course = 'plat_principal', cuisine_type = 'française' WHERE id = '79253691-e945-4849-9104-03f56368beca';
...
-- Pain Matlouh
UPDATE recipes SET course = 'pain_viennoiserie', cuisine_type = 'française' WHERE id = 'ec9d0977-bbed-4aba-8eb1-c91dfcdbaa88';
...
-- Pain pitas Libanais
UPDATE recipes SET course = 'pain_viennoiserie', cuisine_type = 'française' WHERE id = '3ec7b11a-ebf1-4872-9cd4-a5d290714ef7';
...
UPDATE recipes SET course = 'plat_principal', cuisine_type = 'française' WHERE id = '4a004c73-d644-4de5-ba78-790368b9e8e0';

-- Palmiers apéro aux tomates séchées
UPDATE recipes SET course = 'plat_principal', cuisine_type = 'française' WHERE id = '2aa1d609-ca64-442c-b2b5-162d5fd51eb9';

-- Pampushky sauce à l''ail et aneth
UPDATE recipes SET course = 'sauce_condiment', cuisine_type = 'française' WHERE id = '876e2906-1fa9-4352-aae8-c303d5e8a17f';
...
-- Panisses au four
UPDATE recipes SET course = 'plat_principal', cuisine_type = 'française' WHERE id = '7390d771-402f-47b3-affd-6b9d482ffee5';

-- Paris-Brest généreux
UPDATE recipes SET course = 'plat_principal', cuisine_type = 'française' WHERE id = '78d13693-094b-4dc4-ae0d-18faaebf12b0';
...
UPDATE recipes SET course = 'plat_principal', cuisine_type = 'française' WHERE id = '35c3539d-d388-4e06-80c2-cada1a494e81';

-- Petits pois à l''ancienne
UPDATE recipes SET course = 'plat_principal', cuisine_type = 'française' WHERE id = '3df3d317-65d1-409a-9db5-68bb511228c4';

-- Petits soufflés légers au chou-fleur
UPDATE recipes SET course = 'plat_principal', cuisine_type = 'française' WHERE id = '19af7996-5054-4a1f-8aa6-2c2cf13d1403';

-- Pizza de pastèque par Laurent Mariotte
UPDATE recipes SET course = 'plat_principal', cuisine_type = 'italienne' WHERE id = '17723ed7-44aa-4251-ace1-d73f98608a5d';
...
UPDATE recipes SET course = 'sauce_condiment', cuisine_type = 'française' WHERE id = '7bfc8a81-5ed0-403d-a515-e903ad1ef5e8';

-- Poires rôties au miel, yaourt grec à la vanille et semoule grillée
UPDATE recipes SET course = 'plat_principal', cuisine_type = 'française' WHERE id = '3034d22f-a18b-43e4-9e5c-ab569700f1d6';

-- Poivrons au Air Fryer
UPDATE recipes SET course = 'plat_principal', cuisine_type = 'française' WHERE id = 'f0df0a2e-0e72-4afe-81a1-5b1606659599';

-- Polenta au four
UPDATE recipes SET course = 'plat_principal', cuisine_type = 'française' WHERE id = '64e7a129-72f1-4e15-b051-0c778643039e';

-- Polenta au thermomix
UPDATE recipes SET course = 'plat_principal', cuisine_type = 'française' WHERE id = '006956b9-749d-42b7-86f0-1b24c0ceb583';
...
-- Polenta crémeuse
UPDATE recipes SET course = 'plat_principal', cuisine_type = 'française' WHERE id = '8c40310c-6668-40f5-bdd0-d46de635d30b';

-- Pomme de terre au barbecue avec aluminium
UPDATE recipes SET course = 'plat_principal', cuisine_type = 'française' WHERE id = '36e50404-d2e3-4455-bf4e-79845e1ba960';

-- Pommes de terres sautées
UPDATE recipes SET course = 'plat_principal', cuisine_type = 'française' WHERE id = '5e75066f-ece9-4491-b9bf-1503e92dce23';

-- Porridge
UPDATE recipes SET course = 'petit_dejeuner', cuisine_type = 'française' WHERE id = '9bec3cff-73be-490d-b7e4-45e9a642b9e4';
...
UPDATE recipes SET course = 'plat_principal', cuisine_type = 'française' WHERE id = '792cd5ac-7869-4aaf-a601-d4b9dcff244c';
...
UPDATE recipes SET course = 'plat_principal', cuisine_type = 'française' WHERE id = 'ee274549-7179-4020-897f-5301dd42e19d';

-- Poêlée de champignons et d''oignons
UPDATE recipes SET course = 'plat_principal', cuisine_type = 'française' WHERE id = '02d20a88-fcb9-40bd-b0ab-0d31495df8c1';

-- Punch aux fruits
UPDATE recipes SET course = 'plat_principal', cuisine_type = 'française' WHERE id = 'c30598dc-2d54-4472-97ba-74f714ca8c84';
...
UPDATE recipes SET course = 'plat_principal', cuisine_type = 'française' WHERE id = '34a6f2af-c338-4eb8-a1de-7d2d81a5d3d3';

-- Purée pommes de terre et petits pois
UPDATE recipes SET course = 'plat_principal', cuisine_type = 'française' WHERE id = '550f19ad-c724-4551-b62c-5652af8f6846';

-- Purée à ma façon
UPDATE recipes SET course = 'plat_principal', cuisine_type = 'française' WHERE id = '913ec28d-e31c-44df-acc6-f5b4fe8477f6';
...
UPDATE recipes SET course = 'plat_principal', cuisine_type = 'française' WHERE id = '565c45ea-9daa-411d-b640-cd18082c3ca2';

-- Pâtes aux quatre fromages
UPDATE recipes SET course = 'plat_principal', cuisine_type = 'française' WHERE id = '3be767e8-e905-4e41-8e60-8aa740bd9f56';
...
UPDATE recipes SET course = 'sauce_condiment', cuisine_type = 'française' WHERE id = '9570e18f-05bb-4d43-ab3b-3759748cd360';

-- Pâtes à la Norma
UPDATE recipes SET course = 'plat_principal', cuisine_type = 'française' WHERE id = 'b5f77bba-8722-437a-9a68-f8b6d3f0cd0a';
...
UPDATE recipes SET course = 'plat_principal', cuisine_type = 'française' WHERE id = '84ee6438-98bd-49a8-a4a5-4f686deff3a3';
...
UPDATE recipes SET course = 'plat_principal', cuisine_type = 'française' WHERE id = 'aab37f11-ef3e-4776-b06f-9a20aa93ec53';
...
-- Riz au Cookeo
UPDATE recipes SET course = 'plat_principal', cuisine_type = 'française' WHERE id = '4899e1d4-84db-4eb7-987c-34839d815949';
...
UPDATE recipes SET course = 'accompagnement', cuisine_type = 'française' WHERE id = 'eada82de-2d92-4abf-8d3d-17ab3a519a0c';

-- Riz pour sushis
UPDATE recipes SET course = 'plat_principal', cuisine_type = 'japonaise' WHERE id = '814cd3e4-e0bb-4b13-9c9b-f3f1b0789c23';
...
UPDATE recipes SET course = 'plat_principal', cuisine_type = 'française' WHERE id = '43e2c4d1-ba95-4a40-a25e-25b2c9ae2e6d';
...
UPDATE recipes SET course = 'plat_principal', cuisine_type = 'française' WHERE id = '4d13fc0f-c01d-4b99-bf06-a7646319a7cf';
...
-- Salade César
UPDATE recipes SET course = 'entree', cuisine_type = 'française' WHERE id = '085f1ffa-7572-4889-8a2c-efb7b19bb546';
...
UPDATE recipes SET course = 'plat_principal', cuisine_type = 'française' WHERE id = 'd859a50b-e149-404b-8545-26573be5f878';
...
UPDATE recipes SET course = 'plat_principal', cuisine_type = 'française' WHERE id = 'fc013b98-f0fd-421b-b51b-e13655646c95';
...
-- Scones faciles
UPDATE recipes SET course = 'plat_principal', cuisine_type = 'française' WHERE id = 'bf47bddb-e4ac-4d8c-a88b-f7d9056378c4';
...
UPDATE recipes SET course = 'plat_principal', cuisine_type = 'française' WHERE id = '500fcb38-6175-41f6-80b5-a3212fcc4a67';

-- Semoule aux épices
UPDATE recipes SET course = 'plat_principal', cuisine_type = 'française' WHERE id = '2b2fdc1d-0f6e-423f-9955-67684c4844ce';

-- Sirop de fraises gourmand pour brochettes de Fraises du Périgord IGP
UPDATE recipes SET course = 'plat_principal', cuisine_type = 'française' WHERE id = '789d1a0d-0348-475f-aecb-1b44f82c6919';

-- Smoothie fruits rouges/banane
UPDATE recipes SET course = 'boisson', cuisine_type = 'française' WHERE id = '13c4c4eb-551b-4e8a-b4d3-81faaaffa7a9';
...
-- Soufflé au fromage
UPDATE recipes SET course = 'plat_principal', cuisine_type = 'française' WHERE id = 'e89803d0-5fa1-4edb-b64d-83a736049043';
...
UPDATE recipes SET course = 'entree', cuisine_type = 'française' WHERE id = '1a955205-72d5-4d16-bad9-c5d4cd79ea9d';
...
-- Tataki de thon
UPDATE recipes SET course = 'plat_principal', cuisine_type = 'française' WHERE id = '669b4bf3-7b7f-456f-aeae-8f264a8450ab';
...
-- Tian express
UPDATE recipes SET course = 'plat_principal', cuisine_type = 'française' WHERE id = 'df940722-e29c-42f9-afcc-cef526ebbc68';
...
UPDATE recipes SET course = 'plat_principal', cuisine_type = 'française' WHERE id = '940b7e78-7750-4d6b-83d9-8f873c8d3288';

-- Tuiles au parmesan inratable
UPDATE recipes SET course = 'plat_principal', cuisine_type = 'française' WHERE id = 'b3ebf37c-868c-43cb-aeee-0895fbdc9853';
...
UPDATE recipes SET course = 'entree', cuisine_type = 'française' WHERE id = 'e72188b9-17a8-4b4a-9b7c-4d0c850b4fca';

-- Véritable moelleux au chocolat
UPDATE recipes SET course = 'plat_principal', cuisine_type = 'française' WHERE id = '5c122af2-3bc7-4e01-a501-66e0c85a86b1';

-- Véritables raviolis japonais de A à Z (Gyoza)
UPDATE recipes SET course = 'plat_principal', cuisine_type = 'italienne' WHERE id = '267c8c8c-092b-41ff-b023-b480a16a49f1';

-- Wrap grillé au poulet et au fromage
UPDATE recipes SET course = 'plat_principal', cuisine_type = 'française' WHERE id = '7517414b-964e-4808-800c-eda9d34ce356';

-- Wraps au fromage frais, concombres et saumon fumé
UPDATE recipes SET course = 'plat_principal', cuisine_type = 'française' WHERE id = '3b118cd1-9c95-42b2-82ac-ce9c47405304';

-- Yaourt glacé express à la fraise
UPDATE recipes SET course = 'plat_principal', cuisine_type = 'française' WHERE id = '4ff9e146-0ac9-45b3-8c51-d265c01dd63f';

-- Yaourt à la noix de coco
UPDATE recipes SET course = 'plat_principal', cuisine_type = 'française' WHERE id = '94945f17-461e-4094-990d-0d59f3988b2e';
...
UPDATE recipes SET course = 'plat_principal', cuisine_type = 'française' WHERE id = 'b3903e07-ba26-4971-8ad3-da4c12a48ea9';
