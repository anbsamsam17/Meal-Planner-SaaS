...
// Copier ce fichier à la racine du projet Next.js 14
...
const config: Config = {
  ...
  theme: {
    ...
    extend: {
      ...
      // -----------------------------------------------------------------------
      // TYPOGRAPHIE — Fraunces + Inter via CSS variables (next/font)
      ...
      // -----------------------------------------------------------------------
      fontFamily: {
        // Display serif éditorial (titres recettes, headings)
        // La variable --font-fraunces est injectée par next/font dans le layout root
        display: ["var(--font-fraunces)", "Georgia", "serif", ...fontFamily.serif],
        // Corps UI (tout le reste)
      ...
      colors: {
        ...
        // Aliases sémantiques pour shadcn/ui compatibility
        background: "hsl(38, 30%, 98%)",
        foreground: "hsl(38, 16%, 10%)",
        card: "hsl(38, 25%, 95%)",
        "card-foreground": "hsl(38, 16%, 10%)",
        popover: "hsl(38, 30%, 98%)",
        "popover-foreground": "hsl(38, 16%, 10%)",
        muted: "hsl(38, 20%, 89%)",
