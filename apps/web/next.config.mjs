...
const securityHeaders = [
  {
    ...
    value: [
      ...
      "img-src 'self' data: blob: https://*.supabase.co https://*.r2.cloudflarestorage.com https://imagedelivery.net https://img.spoonacular.com https://www.themealdb.com https://assets.afcdn.com https://static.afcdn.com https://static.750g.com",
...
const nextConfig = {
  ...
  images: {
    remotePatterns: [
      ...
      {
        // Photos recettes Marmiton (CDN afcdn.com)
        protocol: "https",
        hostname: "assets.afcdn.com",
        pathname: "/recipe/**",
      },
      {
        // Photos recettes Marmiton (CDN alternatif)
        protocol: "https",
        hostname: "static.afcdn.com",
        pathname: "/**",
      },
      {
        // Photos recettes 750g
        protocol: "https",
        hostname: "static.750g.com",
        pathname: "/images/**",
      },
    ],
  },
